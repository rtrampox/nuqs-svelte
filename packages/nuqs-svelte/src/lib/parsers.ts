 ...
 * @param validValues The values you want to accept
 */
export function parseAsStringLiteral<Literal extends string>(validValues: readonly Literal[]) {
  return createParser({
    parse: (query: string) => {
 ...
 * @param validValues The values you want to accept
 */
export function parseAsNumberLiteral<Literal extends number>(validValues: readonly Literal[]) {
  return createParser({
    parse: (query: string) => {
 ...
 */
export function parseAsArrayOf<ItemType>(itemParser: Parser<ItemType>, separator = ",") {
